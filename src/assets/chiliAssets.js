...
import chiliPile from "./chili_pile.png";
import bellOrange from "./bell_orange.png";

export {
  chiliLong, chiliHabanero, chiliDried, chiliDriedDark,
  chiliSingle, chiliCluster, chiliPile, bellOrange,
};
